...
public class Main {
    public static void main(String[] args) {
        ...
        String tryAgainCommunicate = "Please try again";
        ...
        while (trialGuessing != 0) {
            ...
            if (userNumber > numberToGuess) {
                trialGuessing = subtractThePointsAndWriteOutTheMessage(numberToLowCommunicate,
                        tryAgainCommunicate, trialGuessing);
            } else if (userNumber < numberToGuess) {
                trialGuessing = subtractThePointsAndWriteOutTheMessage(numberToHighCommunicate,
                        tryAgainCommunicate, trialGuessing);
            } else {
    ...
    public static int subtractThePointsAndWriteOutTheMessage(String message1, String message2, int tries) {
        tries--;
